...
Route::middleware('auth:web')->group(function () {
    ...
    Route::get('/letters/files/{type?}', 'LetterController@files')->name('letters.files')->where('type','[a-zAZ]*');
    ...
    Route::get('/galleries/{id?}', 'GalleryController@index')->name('galleries.show');
