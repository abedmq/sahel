...
<head><base href="{{url('')}}">
    ...
    <link href="front/css/pages/login/login-2.css" rel="stylesheet" type="text/css" />
...
<!--end::Head-->
<!--begin::Body-->
<body id="kt_body" style="background-image: url(front/media/bg/bg-10.jpg)" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled">
<!--begin::Main-->
...
{{--<script src="front/js/pages/custom/login/login-general.js"></script>--}}
<!--end::Page Scripts-->
